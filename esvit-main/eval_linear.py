...
def validate_network(val_loader, model, linear_classifier, n, avgpool, depths):
    ...
    for inp, target in metric_logger.log_every(val_loader, 20, header):
        ...
        k = 2 # placeholder in practice, as we have a binary classification with AD
              # your top2 accuracy is always now 100%, but keep it here if you start having multiple classes
        acc1, acc2 = utils.accuracy(output, target, topk=(1, k))
